          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-12 col-md-9 col-lg-6 col-xl-5">
              <div class="mx-auto mb-5">
                <span class="text-muted">My Project Here</span>
                <h2 class="display-5 fw-bold mt-2 mb-4">My Project</h2>
                ...
                <a class="btn btn-primary d-inline-block" href="/projects">Read More</a>
              </div>
            </div>
